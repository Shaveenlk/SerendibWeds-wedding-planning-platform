    ...
    // <CssBaseline />
        <div>
            <Grid container direction="column" alignItems="flex-start">
                <Grid item>
                <Typography variant="h2" sx={{ padding: '60px 20px 20px 20px' }}>{texts[0]}</Typography>
                </Grid>
                <Grid item>
                <Typography variant="h4" sx={{ padding: '20px' }}>{texts[1]}</Typography>
                </Grid>
                <Grid item>
            ...
            <Stack spacing={2} direction='row' sx={{ padding: '10px 50px 10px 50px'}}>
                ...
                <Button variant='contained' sx={{ backgroundColor: '#C19C76', color: 'black' }}>Plan With Us</Button>
                <Button variant='contained' sx={{ backgroundColor: '#C19C76', color: 'black' }}>Add your Service</Button>
            </Stack>
        </div>
    // </ThemeProvider> 
  )
