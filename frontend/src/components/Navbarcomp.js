      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          {isLoggedIn ? (
            <Box sx={{ flexGrow: 0 }}>
              <Tooltip title="Open settings">
                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                  ...
                  <Typography variant="body2" sx={{ mx: 1, color: 'Highlight' }}>
                ...
                {settings.map((setting) => (
                  <MenuItem key={setting} onClick={()=>handleCloseUserMenu(setting)}>
                    {setting === 'Profile' ? (
                      ...
                      <MenuItem onClick={handleLogout}> {/* Change this line */}
                        <Typography textAlign="center">{setting}</Typography>
                            </MenuItem>
                    ) : (
                      <Typography textAlign="center">{setting}</Typography>
            ...
            <Box>
              <Button component={NavLink} to="/signup" sx={{ color: 'black', mx: 1 }}>
                Sign In
              </Button>
              <Button component={NavLink} to="/login" sx={{ color: 'black', mx: 1 }}>
                Login
              </Button>
            </Box>
          )}
